...
```sh
$ npm i avue-form-design-zkq
或
$ yarn add avue-form-design-zkq
```

### 源码

<a href="https://github.com/CYan596/avue-form-design" target="_blank">github</a> or
...
```
import AvueFormDesign from 'avue-form-design-zkq'
